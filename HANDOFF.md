...
- Thứ tự card trong nhóm rank: `typeOrder()` trước, cùng thẻ thì giữ nguyên thứ tự trong KV (`Array.sort` của JS là stable). Project chưa điền phân loại (hoặc thẻ lạ) xếp cuối nhóm — cùng tinh thần "không ẩn ai" với box Watchlist theo narrative
